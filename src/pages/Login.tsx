...
const Login: React.FC = () => {
  ...
  const { user: currentUser, loading: isLoading, error: authError } = useSelector((state: RootState) => state.auth);
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const resultAction = await dispatch(signup({ displayName: name, email, password }) as any);
