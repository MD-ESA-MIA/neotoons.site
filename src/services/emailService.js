class EmailService {
    constructor() {
        this.apiKey = null;
        this.appEmail = 'neotoons.site.help@gmail.com';
    ...
    initializeService() {
        ...
        if (!this.apiKey) {
            console.warn('⚠️ Resend API key not configured. Email sending will be disabled. Set RESEND_API_KEY environment variable.');
            return;
        }
