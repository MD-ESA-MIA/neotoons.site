 ...
 */
export function detectPlatform(userInput) {
    const lowerInput = userInput.toLowerCase();
    if (lowerInput.includes('tiktok') || lowerInput.includes('short') || lowerInput.includes('viral'))
        return 'tiktok';
    if (lowerInput.includes('youtube') || lowerInput.includes('long form'))
        return 'youtube';
    if (lowerInput.includes('instagram') || lowerInput.includes('reel'))
        return 'instagram';
 ...
 */
export function detectTone(userInput) {
    const lowerInput = userInput.toLowerCase();
    if (lowerInput.includes('funny') || lowerInput.includes('humor') || lowerInput.includes('comedy'))
        return 'funny';
    if (lowerInput.includes('dramatic') || lowerInput.includes('emotional'))
        return 'dramatic';
    if (lowerInput.includes('inspire') || lowerInput.includes('motivat'))
        return 'inspirational';
    if (lowerInput.includes('teach') || lowerInput.includes('learn') || lowerInput.includes('educational'))
        return 'educational';
    if (lowerInput.includes('controversial') || lowerInput.includes('debate'))
 ...
 */
export function extractContext(userInput) {
